...
module.exports = !__webpack_require__(46) && !__webpack_require__(58)(function () {
...
var _json = __webpack_require__(395);

var JSON = _interopRequireWildcard(_json);

var _math = __webpack_require__(398);
...
log(a + ' + ' + b + ' = ' + (0, _math.sum)(a, b));

var obj = { a: a, b: b };

log('typeof JSON = ' + (typeof JSON === 'undefined' ? 'undefined' : (0, _typeof3["default"])(JSON)));
log('obj = ' + JSON.stringify(obj));

var arr = [1, 2, 3, 4, 5];

log('Sum = ' + arr.reduce(function (accum, next) {
  return accum + next;
}));
log('Hello World!');
...
// 25.1.2.1.1 %IteratorPrototype%[@@iterator]()
__webpack_require__(44)(IteratorPrototype, __webpack_require__(48)('iterator'), function () { return this; });
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(277));
...
;(function () {
  ...
  var isLoader = "function" === "function" && __webpack_require__(397);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(396)(module), __webpack_require__(89)))
...
var sum = exports.sum = function sum(c, b) {
  return c + b;
};
