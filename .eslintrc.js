module.exports = {
    ...
    rules: {
        ...
        "curly": ["error", "multi-or-nest"], // specify curly brace conventions for all control statements
        ...
        "max-len": [2, 78], // specify the maximum length of a line in your program (off by default)
